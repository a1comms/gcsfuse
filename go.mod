...
require (
	cloud.google.com/go v0.11.1-0.20170807235027-9be7f826df5c
	github.com/codegangsta/cli v1.19.2-0.20170804093415-b99aa811b4c1
	...
	google.golang.org/appengine v1.0.1-0.20170801183137-c5a90ac045b7
)
